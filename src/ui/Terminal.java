...
public class Terminal extends JPanel implements KeyListener {
    ...
    public Terminal(String title, Dimension d, String tilesetsFile, int characterWidth, int characterHeight) {
        ...
        try {
            ...
            // R�cup�ration de la couleur du background
            ...
            // On modifie le fond des caract�res
            ...
            // Cr�ation du tileset dont on a modifier la couleur du background
            ...
            // On dessine cela dans le bufferedImage finale duquel on va r�cup�rer les caract�res
    ...
    private LookupOp setColorCharacter(Color bgColor, Color fgColor){
        ...
        // R�cup�ration des composantes couleurs de la couleur du caract�re
        ...
        for(short j = 0; j < 256; j++){
            ...
            if(j != 0){
                 ...
                 * dcr = 180     255
                 *   j =  ?      50
                 * Permet de r�partir la couleur demand� par l'utilisateur pour que de [0 a 255],
                 * il y est la couleur du caract�re de [0 a X]
                 */
                // Rouge
                if(dcr != 0){
                    //red[j] = dcr;
